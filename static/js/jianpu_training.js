...
(function () {
    ...
    var JIANPU_LIBRARY = [
        { title: '小星星', jianpu: '1 1 5 5 6 6 5 - | 4 4 3 3 2 2 1 - | 5 5 4 4 3 3 2 - | 5 5 4 4 3 3 2 -' },
        { title: '两只老虎', jianpu: '1 2 3 1 | 1 2 3 1 | 3 4 5 - | 3 4 5 - | 5̇ 6 5̇ 4 3 1 | 5̇ 6 5̇ 4 3 1 | 2 5 1 - | 2 5 1 -' },
        { title: '欢乐颂', jianpu: '3 3 4 5 5 4 3 2 | 1 1 2 3 3 2 2 - | 3 3 4 5 5 4 3 2 | 1 1 2 3 2 1 1 -' },
        { title: '生日快乐', jianpu: '5 5 6 5 1̇ 7 | 5 5 6 5 2̇ 1̇ | 5̇ 5̇ 3̇ 1̇ 7 6 | 4̇ 4̇ 3̇ 1̇ 2̇ 1̇' },
        { title: '送别', jianpu: '5 3 5 1̇ - | 7 6 1̇ - | 5 1 2 3 2 1 | 2 - - -' },
        { title: '茉莉花', jianpu: '3 3 5 6 1̇ 1̇ 6 | 5 5 6 5 - | 3 3 5 6 1̇ 1̇ 6 | 5 5 6 5 -' }
    ];
    ...
    function loadLibraryFromDB(selectSongId) {
        return fetch('/api/jianpu/songs')
            ...
            .catch(function (err) {
                console.error('载入数据库曲库失败:', err);
                setStatus('载入曲库失败，请刷新重试', 'bad');
            });
    }
